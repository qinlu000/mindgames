...
def register(id: str, entry_point: Callable, default_wrappers: Optional[List[type[Wrapper]]]=None, **kwargs: Any):
...
def register_with_versions(id: str, entry_point: Callable, wrappers: Optional[Dict[str, List[type[Wrapper]]]]=None, **kwargs: Any):
    """Register an environment with a given ID."""
