...
class HanabiEnv(Env):
    ...
    def _initial_prompt(self, player_id: int, game_state: dict) -> str:
        return (
            ...
            "- After [Play]/[Discard], that card is removed, cards to its right shift left by 1, "
            "and if a card is drawn it is appended at the end (new highest index).\n"
    ...
    def _state_description(self, for_player_id: Optional[int] = None):
        ...
        return (
            ...
            f"Index update reminder: after you [Play]/[Discard] card X, cards to the right of X shift left by 1; "
            f"if a new card is drawn, it is added at the end.\n\n"
