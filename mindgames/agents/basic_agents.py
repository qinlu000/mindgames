...
class HumanAgent(Agent):
    ...
    def __call__(self, observation: str) -> str:
        ...
        print("Human turn")
        print("=" * 72)
        print(cleaned if cleaned else "(empty observation)")
        print("\nExamples: [Play] 0 | [Discard] 0 | [Reveal] player 1 card 0 color red")
        while True:
            action = input("Enter action: ").strip()
            if action:
                return action
            print("Empty action is invalid. Please enter exactly one action.")
...
class AnthropicAgent(Agent):
    ...
    def __init__(self, model_name: str, system_prompt: Optional[str]=STANDARD_GAME_PROMPT, max_tokens: int=2048, temperature: float=0.9, verbose: bool=False):
        """
