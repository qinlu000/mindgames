...
class AnswerTokenAgentWrapper(AgentWrapper):
    def __init__(self, agent: Agent, answer_token: Optional[str]="Final Answer", debugging: bool=False):
...
class ThoughtAgentWrapper(AgentWrapper):
    def __init__(self, agent: Agent, thought_prompt: Optional[str]=None, answer_prompt: Optional[str]=None, debugging: bool=False):
        super().__init__(agent)
